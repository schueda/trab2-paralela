            ...
            with open(file, 'r') as f:
                ...
                for thread in threads:
                    ...
                    with open(file, 'r') as f:
                        ...
                        speedup = seq_ufloat / threads_ufloat
                        row.append(f"{speedup.nominal_value:.2f} ± {speedup.std_dev:.2f}")
                data[row_key] = row
...
\\begin{{table*}}[htbp]
\\centering
\\caption{{Speedup para diferentes números de threads e diferentes entradas e tamanhos de palavra}}
\\label{{tab:speedup}}
\\resizebox{{\\textwidth}}{{!}}{{%
